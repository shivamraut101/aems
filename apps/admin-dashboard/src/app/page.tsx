    ...
    <div className="mx-auto max-w-6xl px-6 py-7">
      ...
      <section className="mt-9">
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <AppUsagePanel period={week} />
          <WorkPatternPanel period={week} />
        </div>
      </section>
...
function AppUsagePanel({ period }: { period: { from: string; to: string } | null }) {
...
function WorkPatternPanel({ period }: { period: { from: string; to: string } | null }) {
